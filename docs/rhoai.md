...
3) Access the `workbench` named `rag-manual-testing-vllm-notebook`.
...
5) In the terminal, run `cd rag-manual-testing-vllm` to navigate to your sample app's directory.
